/*
  ...
  /home/satoken/app/gengetopt/2.22.6/bin/gengetopt -u
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->lambda_help = gengetopt_args_info_help[9] ;
  args_info->mu_help = gengetopt_args_info_help[10] ;
  args_info->nu_help = gengetopt_args_info_help[11] ;
  args_info->d_max_help = gengetopt_args_info_help[12] ;
  args_info->g_max_help = gengetopt_args_info_help[13] ;
  args_info->aa_int_max_help = gengetopt_args_info_help[14] ;
  args_info->rna_int_max_help = gengetopt_args_info_help[15] ;
  args_info->exceeding_penalty_help = gengetopt_args_info_help[16] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVt:c:e:w:D:d:g:", long_options, &option_index);
