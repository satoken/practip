...
const char *gengetopt_args_info_help[] = {
  ...
  "  -i, --init=parameter-file     initial parameters for training",
  ...
  "      --mu=FLOAT                The weight for semi-supervised objective\n                                  (default=`0.5')",
  "      --nu=FLOAT                The weight for the graph regularization term\n                                  for semi-supervised learning  (default=`1.0')",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->init_help = gengetopt_args_info_help[6] ;
  args_info->eta_help = gengetopt_args_info_help[7] ;
  args_info->pos_w_help = gengetopt_args_info_help[8] ;
  args_info->neg_w_help = gengetopt_args_info_help[9] ;
  args_info->lambda_help = gengetopt_args_info_help[10] ;
  args_info->mu_help = gengetopt_args_info_help[11] ;
  args_info->nu_help = gengetopt_args_info_help[12] ;
  args_info->d_max_help = gengetopt_args_info_help[13] ;
  args_info->g_max_help = gengetopt_args_info_help[14] ;
  args_info->aa_int_max_help = gengetopt_args_info_help[15] ;
  args_info->rna_int_max_help = gengetopt_args_info_help[16] ;
  args_info->exceeding_penalty_help = gengetopt_args_info_help[17] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->init_arg));
  free_string_field (&(args_info->init_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->init_given)
    write_into_file(outfile, "init", args_info->init_orig, 0);
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVt:c:i:e:w:D:d:g:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'c':	/* Perform the n-fold cross validation.  */
          ...
          break;
        case 'i':	/* initial parameters for training.  */
        
        
          if (update_arg( (void *)&(args_info->init_arg), 
               &(args_info->init_orig), &(args_info->init_given),
              &(local_args_info.init_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "init", 'i',
              additional_error))
            goto failure;
        ...
        case 'd':	/* The maximim number of iterations of the supervised learning.  */
          ...
          if (update_arg( (void *)&(args_info->d_max_arg), 
              ...
              &(local_args_info.d_max_given), optarg, 0, "25", ARG_INT,
              check_ambiguity, override, 0, 0,
              "d-max", 'd',
              additional_error))
            goto failure;
        ...
        case 'g':	/* The maximum number of iterations of the semi-supervised learning.  */
          ...
          if (update_arg( (void *)&(args_info->g_max_arg), 
              ...
              &(local_args_info.g_max_given), optarg, 0, "5", ARG_INT,
              check_ambiguity, override, 0, 0,
              "g-max", 'g',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          /* The weight for semi-supervised objective.  */
          else if (strcmp (long_options[option_index].name, "mu") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->mu_arg), 
                ...
                &(local_args_info.mu_given), optarg, 0, "0.5", ARG_FLOAT,
                check_ambiguity, override, 0, 0,
                "mu", '-',
                additional_error))
              goto failure;
          ...
          /* The weight for the graph regularization term for semi-supervised learning.  */
