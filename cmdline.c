  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVe:D:G:d:g:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'd':	/* The maximim number of iterations of the supervised learning.  */
          ...
          break;
        case 'g':	/* The maximim number of iterations of the semi-supervised learning.  */
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "cross-validation") == 0)
          {
          ...
          /* The weight for positive interactions.  */
